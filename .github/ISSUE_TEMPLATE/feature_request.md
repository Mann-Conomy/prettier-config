...
about: "Request a new rule or feature for the Prettier config"
title: "[FEATURE] - "
labels: ["enhancement"]
---
...
If applicable, provide an example of how the new feature or improvement would be configured in a `.prettierrc.js` or a `.prettierrc.mjs` file.
